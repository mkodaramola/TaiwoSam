...
// ================================================================
// CHECK IF ALL FOUR SENSORS ARE WET ENOUGH
// ================================================================
...
bool allSensorsWet()
{
    for (int i = 0; i < 4; i++)
    {
        if (soilMoisture[i] < WET_THRESHOLD)
        {
            return false;
        }
    }
...
void controlPump()
{
    /*
      ...
      Only when ALL 4 sensors are >= 60%.
    */
    ...
    {
        /*
          Pump remains ON until all four
          sensors reach at least 60%.
        */
...
void setup()
{
    ...
    */
    ...
    /*
      Push the initial mode to Firebase so the
      database reflects what the device booted into.
    */
