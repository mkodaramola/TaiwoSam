...
const int tareOffset_eepromAddress = 9;
unsigned long t = 0;
...
void calibrate() {
  ...
  // Write tare offset value to EEPROM
  float tareOffset = LoadCell.getTareOffset();
  EEPROM.put(tareOffset_eepromAddress, tareOffset);
  Serial.print("Tare offset value ");
  Serial.print(tareOffset);
  Serial.print(" saved to EEPROM address: ");
  Serial.println(tareOffset_eepromAddress);
