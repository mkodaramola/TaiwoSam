...
void calibrate() {
  ...
  CalTare[0] = newCalibrationValue;
  CalTare[1] = tareOffset;
  ...
  EEPROM.put(calVal_eepromAdress, CalTare);
  Serial.print("Calibration and Tare value ");
  Serial.print("are saved to EEPROM address: ");
