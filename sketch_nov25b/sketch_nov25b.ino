...
const char* firebaseURL = "https://intrudercapture-default-rtdb.firebaseio.com/SavedImage.json";
...
//bool sendFirebaseValue(String base64) {
//  if (WiFi.status() == WL_CONNECTED) {
//    HTTPClient http;
//    String jsonData = "{\"Image64\":" + base64 + "}";
//
//    http.begin(FIREBASE_HOST + firebaseJson); // Specify the URL for mqvalue
