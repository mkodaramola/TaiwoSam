...
//        }
  ...
  if(CSstate.equals("ASCENT") && Altitude > 110) {

      digitalWrite(deploy_nich, HIGH);
      delay(3000);
      digitalWrite(deploy_nich,LOW);
    
    }


  if(CSstate.equals("DESCENT") && Altitude < 100 && !noseCone_detached){
...
float cal_alt = Altitude-cal_val-3;

if (cal_alt < 0) cal_alt = 0;
String teld;
teld.concat("2082,");
